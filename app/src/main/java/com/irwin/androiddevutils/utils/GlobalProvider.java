...
/**
 * An implementation of ContentProvider use SharedPreferences to store key-value data.
 * Created by Irwin on 2017/8/29.
 */

public class GlobalProvider extends ContentProvider {

    public static final Uri AUTHORITY_URI = Uri.parse("content://cn.irwin.store");
...
//        Log.i("GlobalProvider", "Get: " + key + "= " + value);
...
//        Log.i("GlobalProvider", "get keys: " + Arrays.toString(keys) + "  values: " + Arrays.toString(values));
...
//        Log.i("GlobalProvider", "save : " + key + "= " + value);
        SharedPreferences.Editor editor = mStore.edit();
        if (value != null) {
            editor.putString(key, value);
        } else {
